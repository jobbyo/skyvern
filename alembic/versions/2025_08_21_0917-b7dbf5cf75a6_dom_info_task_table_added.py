...
def upgrade() -> None:
    ...
    op.create_index(op.f('idx_task_dom_workflow_run_id'), 'task_dom_information', ['workflow_run_id'], unique=False)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('idx_task_dom_workflow_run_id'), table_name='task_dom_information')
